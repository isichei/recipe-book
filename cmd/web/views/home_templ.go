...
func HomeComposition(searchResultsView templ.Component, oldBrowser bool, text string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "<!doctype html><html lang=\"en\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><title>Recipe Book</title><!-- Link to Tailwind CSS --><link href=\"https://cdn.jsdelivr.net/npm/tailwindcss@2.1.2/dist/tailwind.min.css\" rel=\"stylesheet\"><style>\n\t\t\t\t.line-clamp-3 {\n\t\t\t\t\tdisplay: -webkit-box;\n\t\t\t\t\t-webkit-line-clamp: 3;\n\t\t\t\t\t-webkit-box-orient: vertical;\n\t\t\t\t\toverflow: hidden;\n\t\t\t\t}\n\t\t\t</style></head><body class=\"bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen\"><div class=\"px-4 md:px-6 lg:px-8 py-8 max-w-7xl mx-auto space-y-8\"><div class=\"flex flex-col space-y-4\"><h2 class=\"text-4xl md:text-5xl font-bold tracking-tight text-gray-900\">Recipe Book</h2><div class=\"bg-white rounded-xl shadow-lg border border-gray-200 flex items-center p-2 focus-within:ring-2 focus-within:ring-green-500 focus-within:border-transparent transition-all\" data-dashlane-rid=\"9b86accfad33fcfd\" data-form-type=\"\"><div class=\"relative flex-1\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400\"><circle cx=\"11\" cy=\"11\" r=\"8\"></circle> <path d=\"m21 21-4.3-4.3\"></path></svg> <input id=\"search-bar\" class=\"w-full h-12 pl-12 pr-4 text-base rounded-lg bg-transparent focus:outline-none text-gray-900 placeholder-gray-400\" name=\"text\" type=\"text\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if oldBrowser {
